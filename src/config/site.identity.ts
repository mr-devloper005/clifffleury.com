export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'clifffleury',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Clifffleury',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'clifffleury.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://clifffleury.com',
